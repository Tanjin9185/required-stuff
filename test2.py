...
class GetMailAttach(object):
    ...
    def save_attach_to_local_directory(self):
        ...
        print(msg_list)
        self.savedir=self.savedir+self.user+time.strftime("/%Y/%m/%d/%H..%M/")
...
GetMailAttach(server="mail.edutechsystem.com", user="rahi@edutechsystem.com", password="RahiNusu420",savedir="/home/rahi/Desktop/")